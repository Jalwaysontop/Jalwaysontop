...
- 🛠️ Built: RoleTrace, a resume and job-matching tool that automates applications end to end
- 🏆 Selected for Amazon ML Summer School 2026 (3k out of 134k applicants), ranked top 1500 nationally in Google Big Code, and Dell Aspire Scholar
- 👯 Looking to collaborate on: open-source robotics or ML + app integrations
- ⚡ Fun fact: my brain + code = magic ✨
...
## 🏆 GitHub Trophies
![](https://github-profile-trophy.vercel.app/?username=Jalwaysontop&theme=radical&no-frame=false&no-bg=false&margin-w=4)
...
![](https://github-contributor-stats.vercel.app/api?username=Jalwaysontop&limit=5&theme=dark&combine_all_yearly_contributions=true)
